...
csv_dir = r"D:\UCL Courses\NSCI0016 Literature Report\dataset and models\deepchem\0314analysis\0430summary\conventional_ml\only_TDA\dataset_full_feat.csv"
colnames = ['FileID', 'TDA_H0_max', 'TDA_H0_min', 'TDA_H0_mean', 'TDA_H0_std', 'TDA_H0_sum', 'TDA_H1_max', 'TDA_H1_min', 'TDA_H1_mean', 'TDA_H1_std', 'TDA_H1_sum', 'TDA_H2_max', 'TDA_H2_min', 'TDA_H2_mean', 'TDA_H2_std', 'TDA_H2_sum', 'theta']
df = pd.read_csv(csv_dir, usecols=colnames)
df.columns = df.columns.str.strip()

# data (change for "with G" and "without G")
X = df.drop(['theta','FileID'], axis=1)
y = df['theta']
